...
cwd = os.getcwd()
base_dir =  cwd +  "/tables/English/"
out_dir = cwd + "/../renderer/public/data/en/"
...
trade_stats             = json.loads(open(f"{cwd}/api_stats.json").read()) # content of https://www.pathofexile.com/api/trade2/data/stats
trade_items             = json.loads(open(f"{cwd}/api_items.json").read()) # content of https://www.pathofexile.com/api/trade2/data/items
